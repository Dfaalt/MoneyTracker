    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="relative overflow-hidden rounded-2xl glass-card p-5 border border-slate-800/80 shadow-card group hover:border-slate-700 transition-all">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div
            className={`p-2 rounded-xl ${isPositiveBalance ? "bg-emerald-500/10 text-emerald-400" : "bg-rose-500/10 text-rose-400"}`}
          >
        ...
        <div className="space-y-1">
          <h3
            className={`text-2xl font-bold font-mono tracking-tight ${isPositiveBalance ? "text-emerald-400" : "text-rose-400"}`}
          >
      ...
      <div className="relative overflow-hidden rounded-2xl glass-card p-5 border border-slate-800/80 shadow-card group hover:border-slate-700 transition-all">
        ...
        <div className="space-y-1">
          <h3
            className={`text-2xl font-bold font-mono tracking-tight ${summary.remainingBudget < 0 ? "text-rose-400" : "text-indigo-300"}`}
          >
